<template><div><h2 id="webassembly-工作原理" tabindex="-1"><a class="header-anchor" href="#webassembly-工作原理"><span>WebAssembly 工作原理</span></a></h2>
...
<ul>
<li>
<p>动态分配：WebAssembly 的内存类似于传统堆内存，用于动态分配数据，比如数组、对象等。</p>
</li>
<li>
<p>手动管理：需要通过 WebAssembly 提供的 API 或者更高层的语言来管理内存（例如使用 malloc 和 free）。</p>
</li>
</ul>
