...
<span class="token punctuation">}</span>
  ...
  <span class="token property">&quot;showCompileOutput&quot;</span><span class="token operator">:</span> <span class="token boolean">true</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>:::</p></template></template></template>`,3)]))}const u=s(e,[["render",o],["__file","point.html.vue"]]);export{u as default};
